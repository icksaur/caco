...
export default [
  ...
  },
  {
    ignores: [
      'node_modules/**',
      'dist/**',
      // Generated by vitest --coverage. Linting it is pure waste, lets istanbul's
      // vendored assets fail --max-warnings 0 for reasons unrelated to our code,
      // and races the test phase, which rewrites this directory while lint reads it.
      'coverage/**',
      'public/*.min.js',
      'public/bundle.js',
