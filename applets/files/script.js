 ...
 *
 * See docs/spec-files-applet.md. The UI is a tab strip + single content
...
(function() {
  ...
  // cachedCwd arrives. See docs/spec-files-applet.md
   ...
   *  Audio extensions (docs/spec-files-applet.md) are listed so
   ...
   *  happens to exist first). See docs/spec-files-applet.md
   */
  ...
  // ── Shell object — see docs/spec-files-applet.md + §4.6 ───────
  /** V3.x.2 eviction config. Read from localStorage at init; null
   *  means disabled. See docs/spec-files-applet.md */
  ...
  function jumpToMostRecent() {
    ...
    // are skipped. See docs/spec-files-applet.md Step 8.1.
    var targetId = null;
  ...
  function buildPersistBody() {
    ...
    // is preserved across reload. See docs/spec-files-applet.md
  ...
  // localStorage. See docs/spec-files-applet.md
  ...
  // state). Roadmap V5+ consolidates. See docs/spec-files-applet.md.
   ...
   *  the diff viewer. See docs/spec-files-applet.md. */
   ...
   *  docs/spec-files-applet.md 1 Render → Merge walk. Pure function. */
