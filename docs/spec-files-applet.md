...
- `docs/spec-files-applet-viewers.md` — the viewer contract + per-viewer behavior.
- `docs/spec-files-applet-edits.md` — the git diff-card + selection/edit server system.
...
Full viewer contract + per-viewer behavior: **see `docs/spec-files-applet-viewers.md`.**
...
git-poller mechanism: **see `docs/spec-files-applet-edits.md`.**
